...
import product from '../assets/landing/three.jpg';
import product1 from '../assets/landing/two.jpg';
import product2 from '../assets/landing/one.jpg';
import ringSound from '../assets/landing/phone-ring.mp3'; // Replace with actual sound file path
...
import { productSliderStyles, COUNTRY_CURRENCY_MAP, MobileCallButton, handleSubmit } from '../utility/payment.js';
...
// Create product-specific reviews for Beyond Slim
const PRODUCT_REVIEWS = [
  {
    ...
    location: "Delhi",
    rating: 5,
    content: "I've struggled with stubborn belly fat for years. After using Beyond Slim for just 3 weeks, I can see visible results! The natural formula really works and my confidence has improved dramatically."
  },
  {
    id: 2,
    name: "Priya Sharma",
    ...
    location: "Mumbai",
    rating: 5,
    content: "I've tried many slimming products before but Beyond Slim actually delivers! My skin feels tighter and I've lost inches from my waist. The oil absorbs beautifully without being greasy."
  },
  {
    id: 3,
    name: "Anand Patel",
    ...
    location: "Bangalore",
    rating: 4,
    content: "Beyond Slim has significantly helped reduce fat around my midsection. The results were noticeable within 10 days of regular use. My trainer was surprised at my improved body composition during my last check."
  },
  {
    id: 4,
    name: "Sunita Singh",
    ...
    location: "Chennai",
    rating: 5,
    content: "After pregnancy, I struggled with losing weight. Beyond Slim has been my lifesaver. I'm back to my pre-pregnancy shape and feeling confident again! The delivery was prompt and customer service excellent."
  },
  {
    id: 5,
    name: "Mohan Reddy",
    ...
    location: "Hyderabad",
    rating: 5,
    content: "At 45, I thought it was too late to get back in shape. Beyond Slim has changed everything. I'm sleeping better, feeling more energetic, and have lost 8 kg in 2 months. Worth every rupee!"
  },
  {
    id: 6,
    name: "Lakshmi Iyer",
    ...
    location: "Pune",
    rating: 4,
    content: "The natural formulation of Beyond Slim appealed to me as I wanted to avoid chemicals. It took about two weeks to feel the effects, but now my clothes fit better and my skin looks healthier. Highly recommend!"
  }
];
...
const Landing = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    email: 'support@beyondslim.in', // Default support email
  ...
  useEffect(() => {
    setOrderDetails({
      ...
      productName: 'Beyond Slim - Ayurvedic Slimming Oil',
  ...
  return (
    <div className="">
      ...
      <audio ref={audioRef} src={ringSound} loop preload="auto" playsInline webkit-playsinline="true" muted={false} autoPlay={true} controls={false} style={{display: 'none'}} />      
                      ...
                      <div>
                        <div className="flex justify-between items-center">
                          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 w-[80%]">
                            Beyond Slim - Ayurvedic Slimming Oil
                          </h1>
        ...
        <section className="mt-20 mb-16 px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              See what our customers have to say about their experience with Beyond Slim Slimming Oil
            </p>
          </div>
